 ...
 * @author CanggihWR
 */
public class KalkulatorBMIcanggih {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
   String nama,kerja,jk,hasil;
   float tb,tb1,tb2,bb,bmi;
   int act;
   
   nama = JOptionPane.showInputDialog(null, "Tuliskan Nama Anda");
   
   kerja = JOptionPane.showInputDialog(null, "Tuliskan Pekerjaan Anda");
   ...
   if (act == JOptionPane.YES_OPTION){JOptionPane.showMessageDialog(null, "Program Akan Keluar");
   System.exit(0);
    }
